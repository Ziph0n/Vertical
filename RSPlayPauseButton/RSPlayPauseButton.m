...
- (void)setPaused:(BOOL)paused animated:(BOOL)animated
{
    if (_paused != paused) {
        ...
        UIBezierPath *personnalPauseBezierPath = nil;
        personnalPauseBezierPath = [UIBezierPath bezierPath];

        // Subpath for 1. line
        [personnalPauseBezierPath moveToPoint:p1];
        [personnalPauseBezierPath addLineToPoint:p2];
        [personnalPauseBezierPath addLineToPoint:p3];
        [personnalPauseBezierPath addLineToPoint:p4];
        [personnalPauseBezierPath closePath];

        // Subpath for 2. line
        [personnalPauseBezierPath moveToPoint:p5];
        [personnalPauseBezierPath addLineToPoint:p6];
        [personnalPauseBezierPath addLineToPoint:p7];
        [personnalPauseBezierPath addLineToPoint:p8];
        [personnalPauseBezierPath closePath];

        UIBezierPath *personnalPlayBezierPath = nil;
        personnalPlayBezierPath = [UIBezierPath bezierPath];
        ...
        [personnalPlayBezierPath moveToPoint:_p1];
        [personnalPlayBezierPath addLineToPoint:_p2];
        [personnalPlayBezierPath addLineToPoint:_p3];
        [personnalPlayBezierPath addLineToPoint:_p4];
        [personnalPlayBezierPath closePath];

        [personnalPlayBezierPath moveToPoint:_p5];
        [personnalPlayBezierPath addLineToPoint:_p6];
        [personnalPlayBezierPath addLineToPoint:_p7];
        [personnalPlayBezierPath addLineToPoint:_p8];
        [personnalPlayBezierPath closePath];


        if (self.animationStyle == RSPlayPauseButtonAnimationStyleSplit) {
            fromPath = self.isPaused ? personnalPauseBezierPath : personnalPlayBezierPath;
            toPath = self.isPaused ? personnalPlayBezierPath : personnalPauseBezierPath;
